...
: REDRAWMAIN-	{ | rect[ /RECT ] -- }
 &hWndMain @ ( hwndMain) rect[ GetWindowRect- drop		\ left top right bottom
 &hWndMain @ ( hwndMain) rect[ 0 InvalidateRect- drop		\ mark for repaint
 &hWndMain @ ( hwndMain) WM_PAINT 0 0 SendMessageA drop	\ repaint
;
...
\   TlsIndex>
\ hWnd Msg wParam lParam DefWindowProcA EXIT
  0 -> res
\  sttstdo
  Msg case
    WM_CLOSE    of
